    ...
    private void seedInsumos() {
        if (insumoRepository.count() < 10) {
            List<Insumo> productos = Arrays.asList(
                ...
                createInsumo("Losartán 50mg", "Caja × 30 tabletas", 22.50, true, 0, "Medicamentos", "losartan_50mg.jpg"),
                ...
                createInsumo("Vitamina C 1g", "Caja × 10 tabletas", 32.00, false, 60, "Vitaminas y Nutrición", "vitamina_c_1g.jpg"),
                createInsumo("Alcohol en Gel Antibacterial", "Frasco × 250ml", 12.50, false, 150, "Cuidado Personal", "alcohol_gel.jpg"),
                createInsumo("Tensiómetro Digital", "Unidad", 145.00, false, 15, "Botiquín y Equipos", "tensiometro.jpg")
            );
